                ...
                <div class="card-contenu-update p-6 bg-white border-b border-gray-200">
                    {!! Form::open(['route' => 'saveChargement']) !!}
                        ...
                        <div class="form-chargement-update">
                            ...
                            <x-input id="nom-chargement-update" type="text" name="nom_chargement" :value="__( $chargement->nom_chargement )"/>
                        </div>
                        <div class="form-chargement-update">
                            <x-label for="places-chargement-update" class="info-chargement">Nombre de places</x-label>
                            <x-input id="places-chargement-update" type="number" name="nb_places" :value="__( $chargement->nb_places )"/>
                        </div>
                        <div class="form-chargement-update">
                            <x-label for="prix-chargement-update" class="info-chargement">Prix /place</x-label>
                            <x-input id="prix-chargement-update" type="number" name="prix" step="any" :value="__( $chargement->prix )"/>
                        </div>
                        <div class="form-chargement-update">
                            <x-label for="modalite-chargement-update" class="info-chargement">Modalités</x-label>
                            <x-input id="modalite-chargement-update" type="text" name="modalite" :value="__( $chargement->modalite )"/>
                        </div>
                        <x-input type="hidden" name="chargement_id" :value="__( $chargement->id_chargement )" />
